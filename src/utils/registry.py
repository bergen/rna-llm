...
model = {
    ...
    "bert": "src.models.sequence.masked_lm.BertForMLM"
}
...
callbacks = {
    ...
    "classification_csv_logging": "src.callbacks.classification_csv_logging.RawDataLoggingCallback",
    "regression_csv_logging": "src.callbacks.regression_csv_logging.RawDataLoggingCallback"
}
